...
class INET_API TCP_lwIP : public cSimpleModule, public LwipTcpStackIf, public ILifecycle
{
  ...
  protected:
    ...
    void process_OPEN_ACTIVE(TcpLwipConnection& connP, cMessage *msgP);
    void process_OPEN_PASSIVE(TcpLwipConnection& connP, cMessage *msgP);
    void process_SEND(TcpLwipConnection& connP, cPacket *msgP);
    void process_CLOSE(TcpLwipConnection& connP, cMessage *msgP);
    void process_ABORT(TcpLwipConnection& connP, cMessage *msgP);
    void process_STATUS(TcpLwipConnection& connP, cMessage *msgP);

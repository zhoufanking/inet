...
class INET_API Ieee80211OFDMModulation : public IModulation
{
    ...
    public:
        ...
        const APSKModulationBase *getModulation() const { return modulation; }
        virtual double calculateBER(double snir, Hz bandwidth, bps bitrate) const { return modulation->calculateBER(snir, bandwidth, bitrate); }
        virtual double calculateSER(double snir, Hz bandwidth, bps bitrate) const { return modulation->calculateSER(snir, bandwidth, bitrate); }

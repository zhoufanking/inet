...
#include "inet/physicallayer/unitdiskradio/UnitDiskListening.h"
#include "inet/physicallayer/unitdiskradio/UnitDiskNoise.h"
#include "inet/physicallayer/unitdiskradio/UnitDiskReceiver.h"
...
bool UnitDiskReceiver::computeIsReceptionAttempted(const IListening *listening, const IReception *reception, IRadioSignal::SignalPart part, const IInterference *interference) const
{
